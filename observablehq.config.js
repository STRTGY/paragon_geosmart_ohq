  ...
  pages: [
    ...
    },
    {
      ...
      pages: [
        ...
        { name: "Caracterización de terreno: Residencial en Ciudad Valles", path: "./pages/03_geosmart/residencial_ciudadvalles" }
      ]
    },
    {
    ...
    },
    {
      ...
      pages: [
        { name: "Vocación de terreno: Hospital en Ciudad Valles", path: "./pages/03_geosmart/hospital_ciudadvalles" },
        { name: "Posibles ubicaciones para hospital en Querétaro", path: "./pages/03_geosmart/hospital_queretaro" }
      ]
    },
    {
      name: "Subproyectos Logísticos",
      pages: [
        { name: "Vocación de terreno:Centro Logístico de Mercado Libre en SLP", path: "./pages/03_geosmart/mercadolibre_sanluispotosi" }
      ]
    },
    {
      name: "Subproyectos de Expansión",
      pages: [
        { name: "Vocación de terrenos: Expansión en Tamuín", path: "./pages/03_geosmart/expansion_tamuin" }
      ]
    },
  ],
